...
import { regionalData } from 'helper/helper';
...
export default function RegionalCards() {
  ...
  return (
    <div className='card bg-white rounded-md grid-margin card-shadow regionalLayout'>
      <div className='cardBody'>
          <div class="cardTitle flex items-center flex-wrap items-center justify-between">
            <div className='mb-4'>
              <p class="f14 semibold text-uppercase text-normal">Regional YTD </p>
                    ...
                    >
                      ...
                      <div className='cardBody block w-full'>
                        ...
                        <div className='flex items-center justify-between mt-1 mb-3'>
                          ...
                          <p className='text-benGray f12'>YTD</p>
                        </div>
                        <div className=''>
