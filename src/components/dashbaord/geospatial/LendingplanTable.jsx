...
export default function LendingplanTable({data,currentPage,setCurrentPage,selectedStatusOption,setSelectedStatusOption,selectedComplexOption,setSelectedComplexOption,setSearchValue,filtersComplexData,filtersStatusData,pageSize,setPageSize}) {
...
dataArray=data.lendingplan;
 ...
 const csvData = [
  ...
  ...dataArray.map(
    ({ boardDate, country, projectName, uaMillion, esiaCat, esiaCatActual, cspStatus }) => [
      boardDate, country, projectName, uaMillion, esiaCat, esiaCatActual, cspStatus
    ]
  ),
];
