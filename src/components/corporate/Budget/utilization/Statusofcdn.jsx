...
const options = {
  ...
  subtitle: {
    ...
    text: `<div class='flex items-center justify-center flex-col'>
            <h4 class='text-bold text-black f25 semibold'>66%</h4>
  ...
  return (
    <div class="">
      <div class="cardTitle flex items-center flex-wrap items-center justify-between">
        <div class="mb-4">
          <p class="f14 semibold text-uppercase text-normal">Status Of CDNs – CSPs And ESWs Budgets</p>
          </div>
      </div>
      <div className=''>
