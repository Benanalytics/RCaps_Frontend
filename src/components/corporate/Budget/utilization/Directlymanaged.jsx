...
const options = {
  ...
  subtitle: {
    ...
    text: `<div class='flex items-center justify-center flex-col'>
            <h4 class='text-bold text-black f32 semibold'>59%</h4>
           ...
           <div>
                <ul class=" flex gap-x-3 justify-center w-full  GeopatitalMap flex-wrap border-t chart_bottom">
                  <li class="px-5 py-5 text-center">
                    <p class="f16 semibold"><span className='text-bold'>UA 10.37 </span></p>
                  ...
                  <li class="text-center px-5 py-5 border-l border-benThinBlue  text-center">
                    <p class="f16 semibold"><span className='text-bold'>UA 6.9 </span></p>
                    <p class="f14 semibold text_light text-benGray">Allotted</p>
                  </li>
                  <li class="text-center px-5 py-5 border-l border-benThinBlue  text-center">
                    <p class="f16 semibold"><span className='text-bold'>UA 4.28 </span></p>
            ...
            {/* <div>
                <ul class=" flex gap-x-3 justify-center w-full  GeopatitalMap flex-wrap border-t chart_bottom">
                  <li class="px-5 py-5 text-center">
                    <p class="f14 semibold"><span className='text-bold'>10.37 </span>Adjust Budget</p>
                  </li>
                  <li class="text-center px-5 py-5 border-l border-benThinBlue  text-center">
                    <p class="f14 semibold"><span className='text-bold'>6.9 </span>Allotted</p>
                  </li>
                  <li class="text-center px-5 py-5 border-l border-benThinBlue  text-center">
                    <p class="f14 semibold"><span className='text-bold'>4.28 </span>Available</p>
                  </li>
                </ul>
            </div> */}
        </div>
...
export default Directlymanaged;
