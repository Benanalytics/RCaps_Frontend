...
const FootprintIncomeAnalysis = () => {
  const options = {
    ...
    yAxis: {
      ...
      tickPositions: [0, 50, 100, 150, 250,300,350],
      stackLabels: {
        enabled: true,
        style: {
          fontWeight: "bold",
    ...
    series: [
      ...
      {
        name: "Projected",
        data: [58, 79, 75, 124,56,42],
        color: "#8b7dfa",
      },
      {
        name: "Historical",
        data: [59, 81, 135, 198,62,72],
        color: "#3ce9d0",
      },
      ...
      <div class="cardBody">
          <div class="cardTitle flex items-center flex-wrap items-center justify-between">
              <div class="mb-4">
                  ...
                  <p class="f13 semibold text-light text-benGray">Historical (2018-2020)Vs(2022-2024)Annual Income Per Sector</p>
              </div>
          </div>
...
export default FootprintIncomeAnalysis;
