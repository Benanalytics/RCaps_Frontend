...
const CapacityUtilization = () => {
  const options = {
    ...
    series: [
        ...
        {
            data: [55, 25, 25, 25,25],
            name: "Overall Workstation Utilization Rate",
            type: "line",
            color: "#f4c852",
            marker: {
              enabled: true,
      ...
      
      {
        ...
        data: [600, 152, 147, 178,108],
        color: "#8b7dfa",
      },
      {
        name: "Income Per Staff",
        data: [120, 80, 99, 189,118],
        color: "#3ce9d0",
      },
  ...
  return (
    ...
    <div class="cardBody">
        <div class="cardTitle flex items-center flex-wrap">
            <p class="f14 semibold text-uppercase text-normal mb-4">Capacity Utilization</p>
        </div>
        <div className='mt-4'>
