...
import LendingProjectFinancingAndPerformanceTable from "components/dashbaord/geospatial/LendingProjectFinancingAndPerformanceTable";
...
const downloadPDF = () => {
  ...
  const navigation = [
    ...
    { name: "Plan", href: "/geospatial", icon: RiFileList3Line, current: false },
    {
      name: "Approval",
  ...
  const NavbarTabs = [
    ...
    { name: "LENDING", href: "/lendingApproval", icon: BsMap, current: true },
  ...
  useEffect(()=>{
    ...
    if(selectedOption)
      ...
      const handleGrowthOperationData=async()=>{
        ...
        await instance.post(`DataManagement/Lending-approval/GetGrowOperationData`,data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
      ...
      const handleTotalProjectAmountUAData=async()=>{
        ...
        const data = {
         ...
         const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetTotalProject&AmountUA`,data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleGetGeospatialAnalyticsData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetGeospatialAnalyticsData`, data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleScalingForTransformationData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetLendingVolumeData`, data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleInfastructureFundingAndStrategicInvestmentData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetSectorFinancialInvestData`,data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleCountryInvestmentSpectrumData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetCountryWorkStat&FinancialAnalysisData`,data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleSectoralInvestmentRangesData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetUAProjectOnSector&SectorRange`,data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleGetGeospatialAnalyticsGraphData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetOperationType&CountryInvestSpectData`,data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleGetRegionMapData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetRegionMapData`, data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleGetRegionData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetUAMillionOnRegionData`, data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleSectorAllocationBreakDownData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetSectorsUaMillions`,data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleFinancingAndPerformanceData=async()=>{
        ...
        const accessToken = auth.userInfo.accessToken;
        await instance.post(`DataManagement/Lending-approval/GetLendingApprovalData`, data,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
      ...
      const handleFiltersData=async()=>{
        ...
        await instance.post(`DataManagement/Lending-approval/GetReportTypes`,data ,{ headers: { "Authorization": `Bearer ${accessToken}` } })
            .then(response => {
               if(response.status===200){
  ...
  return (
    ...
    <div style={{ width: "100%", height: "auto" }}  className="ben__GeospatialPage ben_LandingPage  w-full block flex-wrap">
      ...
      <div className="ben__GeospatialPage ben_LandingPage  w-full block flex-wrap">
        ...
        <div className="TabsLayout mb-6 flex flex-wrap justify-content-between border-b printHide">
          ...
          TOTAL: {totalProject} operations, amounting to UA {totalUAAmount} million as Lending
            Approval
          </div>
    ...
    <div  id="pdf-content" >
        ...
        <div className='flex h100 flex-col justify-between'>
          ...
          <div className="cardBody">
            <select
              ...
              >
                <option value="">Select Lending Approval</option>
          ...
          <div className="card bg-white rounded-md card-shadow grid-margin flex1">
            <div className="cardBody">
              <div className="">
                ...
                <p class="f13 semibold  text-normal mb-4">{new Intl.NumberFormat('en-IN').format(Math.round(lendingAppData.numberOfProject))} Projects</p>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 CardDivgap">
        <div className="card bg-white rounded-md card-shadow grid-margin printnotbreak printnotbreak">
          <div className="cardBody">
            <div class="cardTitle flex justify-between items-center mb-4 ">
              ...
              <p class="f14 semibold text-uppercase text-normal">
                ...
                <div className="flex items-center gap-x-2 flex-wrap">
                  <p className="f13 text-benGray">Annually:</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 CardDivgap">
        ...
        <div className="printnotbreak">
          <LendingProjectFinancingAndPerformanceTable 
...
export default LendingApproval;
